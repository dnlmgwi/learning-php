            ...
            <form >
                ...
                <div class=" d-flex flex-column align-items-center gap-4 mb-5 page-width">
                    ...
                    <div class="d-flex flex-column align-items-start w-100">
                        ...
                        <input type="email" class="form-control p-3 rounded border-secondary w-100" name="" id=""
                    ...
                    <div class="d-flex flex-column align-items-start w-100">
                        ...
                        <input type="password" class="form-control p-3 rounded border-secondary w-100" name="" id=""
                    ...
                    <div>
                        ...
                        <a href="/dashboard/"><span class="fw-semibold text-decoration-underline"
                                style="font-size: 14px;">Create
                                Account</span></a>
                    </div>
                </div>
